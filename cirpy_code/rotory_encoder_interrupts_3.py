...
def handle_interrupt():
    ...
    encoder_delta = seesaw.encoder_delta()
    ...
    # if position != last_position and abs(position - last_position) < 10:
...
while True:
    ...
    if not rotory_int.value:  # Interrupt triggered
        handle_interrupt()
    ...
    if not button.value and not button_held:
        ...
        print(f"Position: {seesaw.encoder_position()}")
